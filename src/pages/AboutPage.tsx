  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-[1140px] px-5 pb-8 md:px-8">
        <p className="mx-auto mb-10 max-w-4xl text-center text-[20px] font-normal leading-loose" data-aos="fade-up">
        ...
        <div className="mb-12 grid items-center gap-8 md:grid-cols-2 md:gap-16 ">
          <p className=" text-justify text-ink/70 leading-loose" data-aos="fade-right">
        ...
        <div className="mb-12 grid items-center gap-8 md:grid-cols-2 md:gap-16" data-aos-offset="300">
          <img
            ...
            data-aos="fade-right"
          />
          <p className="text-ink/70 md:order-2 text-justify leading-loose" data-aos="fade-left">
        ...
        <div className="mx-auto max-w-[1140px]">
          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
            {services.map((service, index) => (
              <div key={service.id} className="text-left" data-aos="zoom-in" data-aos-delay={`${index * 100}`}>
